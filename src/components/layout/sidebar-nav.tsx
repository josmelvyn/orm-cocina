...
export function SidebarNav({ permisos }: { permisos: string[] }) {
  ...
  // El filtrado ocurre aquí (client component) porque MenuItem incluye
  // referencias a componentes de ícono (lucide-react), que no se pueden
  // pasar como prop serializada desde un Server Component.
  const items = filtrarMenu(permisos)
